    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/pages/product-list.jsp">订单管理</a></li>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick='location.href="${pageContext.request.contextPath}/product/updateProductUI?productId=${product.id}"'>
                                            修改
                                        </button>
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick='javascript:deleteById(${product.id});'>删除
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            每页 <select id="selectsize" class="form-control" onchange="toPage()">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a>
                            </li>
                           <c:forEach items="${pageInfo.navigatepageNums}" var="i">
                               <li><a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
                           </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a>
                            </li>
